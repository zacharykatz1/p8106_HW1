...
enet.fit = train(x = x_all, y = training_data$sale_price,
                  method = "glmnet",
...
mean((enet.pred - test_data$sale_price)^2)
```
...
lm.fit = train(x = x_all, y = training_data$sale_price,
                  method = "lm",
                  preProcess = c("center", "scale"),
                  trControl = control_cv
)

# Comparing different models based only on training error
# Elastic net probably optimal based on this
